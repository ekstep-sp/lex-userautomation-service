...
public enum EmailTemplate {
    ...
    changeRoleTemplate1("<p>Hi %s,</p>" +
            "<p>There has been a change in the roles assigned to you on the platform. Previously, you had the below roles:<br/>"),
    changeRoleTemplate2("</p><p>Now, you have the following roles assigned to you:<br/>"),
